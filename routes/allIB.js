...
route.post('/', check, (req, res) => {
    ...
    let xx = '(select url from images where images.id = id_item limit 1) as url'
    db.query(`select *, ${xx} ,${dateOrder}, ${code}, ${description}, ${customer}, ${customer1}, ${customer2} from  itembooked `, (err, rows, filds) => {
        console.log(rows)
